...
<body>
    ...
    <img width= "90px" src="images/tambah.jpg">
    </div>
    <div class="row">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6 border-left">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    <input class="btn btn-primary btn-block" type="submit" value="Save" id="save">
                                </div>
                                <div class="col">
                                    <input style="background-color:red" class="btn btn-primary btn-block" type="submit" value="Cancel">
                                </div>
                            </div>
                        </div>
                    </div>
